...
export const PropertyCard: React.FunctionComponent<PropertyCardProps> = (props) => {
  ...
  return (
    <div className={propertyCardContainer} style={{ width: 'calc(25%)'}}>
        ...
        <div className={cardContentContainer}>
          <div className={leftContent}>
            ...
            <div className={homeFacts}>
              <div className={fact}><span className={strongFact}>3</span> bed</div>
              <div className={fact}><span className={strongFact}>1</span> bath</div>
            </div>
