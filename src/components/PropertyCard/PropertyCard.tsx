...
import { addressLine, cardContainer, heart, cardContentContainer, ctaButton, fact, homeFacts, image, imageContainer, label, leftContent, locationLine, loveIt, price, propertyCardContainer, rightContent, status, statusDot, strongFact, backroundImage } from "./PropertyCard.css";
    ...
    <div className={propertyCardContainer}>
      ...
      <div className={cardContainer}>
        <div className={imageContainer}>
          <img style={{ position: 'absolute' }} src={ imageOptimization(photos?.[1]?.href) } className={backroundImage} />
          <img style={{ position: 'absolute' }} src={ imageOptimization(photos?.[0]?.href) } className={image} />
