  ...
  return (
    <div className={propertyCardContainer}>
      ...
      <div className={cardContainer}>
        ...
        <img style={{ position: 'absolute', zIndex: -1, objectFit: 'contain', height: '100%', width: '100%' }} src='https://www.svgrepo.com/show/508699/landscape-placeholder.svg' />
          <img src={ imageOptimization(photos?.[0]?.href) } className={image} />
